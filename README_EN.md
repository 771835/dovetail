...
<!-- - [ ] First-class citizen functions (never gonna happen) -->
...
Repetitive tasks, such as numbering, may be handled by AI tools.
...
<!-- In practice even the author doesn't follow this rule. As long as you've reviewed your code thoroughly, understand how it works, and there are no serious AI hallucinations, nobody can tell anyway -->
