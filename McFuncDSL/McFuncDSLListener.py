...
class McFuncDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by McFuncDSLParser#NewSelectorExpr.
    def enterNewSelectorExpr(self, ctx:McFuncDSLParser.NewSelectorExprContext):
        pass

    # Exit a parse tree produced by McFuncDSLParser#NewSelectorExpr.
    def exitNewSelectorExpr(self, ctx:McFuncDSLParser.NewSelectorExprContext):
        pass
