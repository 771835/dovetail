...
def serializedATN():
    return [
        ...
        1,0,0,0,200,201,1,0,0,0,201,202,1,0,0,0,202,203,5,55,0,0,203,204,
        3,16,8,0,204,205,3,20,10,0,205,207,1,0,0,0,206,180,1,0,0,0,206,195,
        1,0,0,0,207,15,1,0,0,0,208,217,5,4,0,0,209,214,3,18,9,0,210,211,
        5,11,0,0,211,213,3,18,9,0,212,210,1,0,0,0,213,216,1,0,0,0,214,212,
        ...
        239,1,0,0,0,238,236,1,0,0,0,239,242,5,9,0,0,240,242,5,10,0,0,241,
        231,1,0,0,0,241,232,1,0,0,0,241,240,1,0,0,0,242,21,1,0,0,0,243,273,
        3,12,6,0,244,246,3,42,21,0,245,247,5,10,0,0,246,245,1,0,0,0,246,
        247,1,0,0,0,247,273,1,0,0,0,248,250,3,40,20,0,249,251,5,10,0,0,250,
        249,1,0,0,0,250,251,1,0,0,0,251,273,1,0,0,0,252,273,3,28,14,0,253,
        273,3,38,19,0,254,256,3,48,24,0,255,257,5,10,0,0,256,255,1,0,0,0,
        256,257,1,0,0,0,257,273,1,0,0,0,258,260,3,44,22,0,259,261,5,10,0,
        0,260,259,1,0,0,0,260,261,1,0,0,0,261,273,1,0,0,0,262,273,3,46,23,
        0,263,265,3,24,12,0,264,266,5,10,0,0,265,264,1,0,0,0,265,266,1,0,
        0,0,266,273,1,0,0,0,267,269,3,26,13,0,268,270,5,10,0,0,269,268,1,
        0,0,0,269,270,1,0,0,0,270,273,1,0,0,0,271,273,5,10,0,0,272,243,1,
        ...
        0,0,0,272,267,1,0,0,0,272,271,1,0,0,0,273,23,1,0,0,0,274,275,5,35,
        ...
        299,1,0,0,0,300,301,1,0,0,0,301,302,1,0,0,0,302,304,5,10,0,0,303,
...
class transpilerParser ( Parser ):
    ...
    ruleNames =  [ "program", "includeStmt", "annotation", "classDecl", 
                   ...
                   "continueStmt", "forStmt", "forControl", "forInit", "condition", 
    ...
    def program(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 36028805635768322) != 0):
                self.state = 75
                self._errHandler.sync(self)
    ...
    def classDecl(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & 36028805634326530) != 0):
                self.state = 116
                self._errHandler.sync(self)
                token = self._input.LA(1)
                if token in [24, 33, 55]:
                    self.state = 107
                    self.varDecl()
                    self.state = 109
                    self._errHandler.sync(self)
    ...
    def block(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while (((_la) & ~0x3f) == 0 and ((1 << _la) & 67558648536237074) != 0):
                    self.state = 233
                    self.statement()
                    self.state = 238
                    self._errHandler.sync(self)
    ...
    def forControl(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & 67558544945184784) != 0):
                self.state = 295
                self.forInit()
