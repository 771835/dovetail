...
class transpilerVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by transpilerParser#interfaceMethodDecl.
    def visitInterfaceMethodDecl(self, ctx:transpilerParser.InterfaceMethodDeclContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by transpilerParser#primitiveType.
    def visitPrimitiveType(self, ctx:transpilerParser.PrimitiveTypeContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by transpilerParser#commandExpr.
