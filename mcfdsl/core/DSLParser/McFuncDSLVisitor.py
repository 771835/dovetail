...
class McFuncDSLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by McFuncDSLParser#breakStmt.
    def visitBreakStmt(self, ctx: McFuncDSLParser.BreakStmtContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by McFuncDSLParser#continueStmt.
